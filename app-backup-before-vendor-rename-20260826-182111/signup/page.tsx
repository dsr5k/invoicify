...
export default function SignupPage() {
  ...
  return (
    <div className="min-h-screen bg-[#0a0a0f] flex items-center justify-center px-4">
      <div className="absolute top-1/3 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[300px] bg-violet-600/10 rounded-full blur-3xl pointer-events-none" />
      ...
      <Card className="w-full max-w-md bg-white/[0.03] border-white/10 text-white relative">
        <CardHeader className="text-center space-y-2">
          ...
          <CardDescription className="text-white/40">Start automating your invoices today</CardDescription>
        </CardHeader>
        ...
        <CardFooter className="justify-center">
          <p className="text-sm text-white/30">
            ...
            <Link href="/login" className="text-blue-400 hover:text-blue-300 underline-offset-4 hover:underline">
              Sign in
            </Link>
          </p>
        </CardFooter>
