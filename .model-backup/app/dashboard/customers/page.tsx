  ...
  return (
    <div className="p-8 space-y-8">
      ...
      <div>
        ...
        <p className="text-white/40 text-sm mt-1">{customers.length} total clients</p>
      </div>
      ...
      <div className="bg-white/[0.03] border border-white/5 rounded-xl p-6">
        ...
        <form onSubmit={handleAdd} className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div className="space-y-2">
            <Label className="text-white/50 text-xs">Business / Customer Name *</Label>
            <Input
              name="name"
              required
      ...
      <div className="bg-white/[0.03] border border-white/5 rounded-xl">
        ...
        {loading ? (
          ...
          <div className="py-16 text-center">
            ...
            <p className="text-white/20 text-xs mt-1">Add your first customer above</p>
          </div>
        ) : (
              ...
              >
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    {customer.gstin && (
                      <p className="text-xs text-white/20 mt-0.5">GST: {customer.gstin}</p>
                    )}
                  </div>
                </div>
