  ...
  return (
    <div className="p-8 space-y-6">
      <div>
        ...
        <p className="text-white/40 text-sm mt-1">GST filing, returns, and compliance management</p>
      </div>
      <div className="bg-white/[0.03] border border-white/5 rounded-xl p-12 flex flex-col items-center justify-center text-center gap-4">
        ...
        <div>
          ...
          <h2 className="text-xl font-bold mt-3 mb-2">GST Compliance Hub</h2>
          <p className="text-white/40 text-sm max-w-md">Auto-generate GSTR-1, GSTR-3B, reconcile ITC, and stay 100% compliant with Indian GST regulations.</p>
        </div>
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 mt-4 w-full max-w-lg">
          {["GSTR-1 / GSTR-3B export", "ITC reconciliation", "E-invoice (IRN) generation", "HSN-wise summary report"].map(f => (
